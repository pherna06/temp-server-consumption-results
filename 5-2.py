...
fig.text(0.5, -0.02, 'Time (inference step)', ha='center', va='center', fontsize='x-large')
fig.text(-0.02, 0.5, 'Power (w)', ha='center', va='center', rotation='vertical', fontsize='x-large')
